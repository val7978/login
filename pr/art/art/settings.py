...
SECRET_KEY = 'django-insecure--wyote-1s2x7g8=@k5_=oo=z&yp(t)_(hu1ca9t2axgz#j_6r('
...
ROOT_URLCONF = 'work_registration.urls'
...
WSGI_APPLICATION = 'work_registration.wsgi.application'
